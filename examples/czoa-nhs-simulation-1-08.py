...
from czoi.core.models import Zone, Role, User, Application, Operation, GammaMapping
...
from czoi.neural.base import NeuralComponent
...
def run_healthcare_comparison():
    ...
    system = System()
    perm_engine = PermissionEngine(system)
